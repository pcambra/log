 ...
 *     "views_data" = "Drupal\log\Entity\LogViewsData",
 *
 *     "form" = {
 ...
 *     "route_provider" = {
 *       "html" = "Drupal\log\LogHtmlRouteProvider",
 *     },
 *   },
 *   base_table = "log",
 ...
 *   },
 *   links = {
 *     "canonical" = "/admin/structure/log/{log}",
 *     "add-form" = "/admin/structure/log/add/{log_type}",
 *     "edit-form" = "/admin/structure/log/{log}/edit",
 *     "delete-form" = "/admin/structure/log/{log}/delete",
 *     "collection" = "/admin/structure/log",
 *   },
...
class Log extends ContentEntityBase implements LogInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['type'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('Type'))
      ->setDescription(t('The Log type/bundle.'))
    ...
    $fields['status'] = BaseFieldDefinition::create('boolean')
      ...
      ->setDescription(t('A boolean indicating whether the Log is published.'))
      ->setDefaultValue(TRUE);

    $fields['langcode'] = BaseFieldDefinition::create('language')
      ->setLabel(t('Language code'))
      ->setDescription(t('The language code for the Log entity.'))
      ->setDisplayOptions('form', array(
