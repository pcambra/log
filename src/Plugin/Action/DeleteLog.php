 ...
 *   label = @Translation("Delete log"),
 *   type = "log",
 *   confirm_form_route_name = "log.multiple_delete_confirm"
 * )
 */
class DeleteLog extends ActionBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new DeleteLog object.
   *
